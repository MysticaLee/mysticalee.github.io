        ...
        <div className="flex md:justify-center">
          ...
          >
            {links.map((link) => (
              <li
                key={link.name}
                className="mx-4 my-5 cursor-pointer border-custom-secondary text-center text-xl text-custom-white hover:text-custom-secondary md:my-0 md:px-1 md:hover:border-b-2"
              >
                <a
